...
{
     /**
     * Returns whether the this <code>PicView</code> will detect collisions with other objects,
     * such as the surface geometry. If true, implementations may also automatically
     * resolve any detected collisions.
     *
     * @return <code>true</code> If this <code>PicView</code> will detect collisions; <code>false</code> otherwise.
     */
    boolean isDetectCollisions();

    /**
     * Sets whether or not this <code>PicView</code> will detect collisions with other objects,
     * such as the surface geometry. If <code>detectCollisions</code> is true, implementations may also automatically
     * resolve any detected collisions.
     *
     * @param detectCollisions If <code>true</code>, this <code>PicView</code> will resolve collisions; otherwise this
     *                          <code>PicView</code> will ignore collisions.
     */
