...
public class BasicOrbitView extends BasicView implements OrbitView
{
    ...
    // TODO
    // Separate control should be provided over whether the PicView will detect collisions
    // which reports through hadCollisions() and flagHadCollisions(),
    // and whether the PicView will resolve collisions itself,
    // something along the lines of isResolveCollisions.
    // At the same time, flagHadCollisions() should be made part of the public PicView interface.
    ...
    public void computeAndSetViewCenter()
    {
        ...
        catch (Exception e)
        {
            ...
            // If updating the PicView's focus failed, raise the flag again.
            this.setViewOutOfFocus(true);
        }
    }
