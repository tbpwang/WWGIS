...
public class WorldWindowGLAutoDrawable extends WorldWindowImpl implements WorldWindowGLDrawable, GLEventListener
{
    ...
    /**
     * The most recent PicView modelView ID.
     *
    ...
    /**
     * Indicates the amount of time, in milliseconds, that the PicView must remain unchanged before a {@link
     * View#VIEW_STOPPED} event is triggered.
     *
     * @return Time in milliseconds that the PicView must must remain unchanged before the view stopped event is
     *         triggered.
     */
    ...
    /**
     * Specifies the amount of time, in milliseconds, that the PicView must remain unchanged before a {@link
     * View#VIEW_STOPPED} event is triggered.
     *
     * @param time Time in milliseconds that the PicView must must remain unchanged before the view stopped event is
     *             triggered.
     */
...
//        this.drawable.setGL(new DebugGL(this.drawable.getGL())); // uncomment to use the debug drawable
    ...
    protected void checkForViewChange()
    {
        ...
        {
            // PicView has changed, capture the new viewStateID
