...
public class WWMath
{
     ...
     * {@link gov.nasa.worldwind.geom.Extent}. If the PicView eye point is inside the extent, this returns 0.
     *
     * @param dc     the {@link gov.nasa.worldwind.render.DrawContext} which the PicView eye point is obtained from.
     * @param extent the extent to compute the distance from.
     *
     * @return the distance from the PicView eye point to the extent, in model coordinates.
     *
     ...
     * coordinates.
     *
     * @param dc     the current draw context, from which the PicView is obtained from.
     * @param extent the extent to compute the window size for.
     *
     * @return size of the specified Extent from the specified PicView, in window coordinates (screen pixels).
     *
     * @throws IllegalArgumentException if either the DrawContext or the extent is null.
     */
     ...
     *
     * @param view   the <code>PicView</code> for which to compute a projected screen area.
