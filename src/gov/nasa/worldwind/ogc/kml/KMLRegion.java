...
public class KMLRegion extends KMLAbstractObject
{
     ...
     * between the Region and the <code>PicView's</code> eye point. If the Region has altitude mode of
    ...
    protected static class RegionData extends ShapeDataCache.ShapeDataCacheEntry
    {
         ...
         * points are used to determine the distance between this entry's Region and the <code>PicView's</code> eye point.
    ...
    protected boolean meetsScreenAreaCriteria(DrawContext dc, KMLLod lod)
    {
        ...
        // Compute the projected screen area of this Region's extent in square pixels in the DrawContext's PicView.
