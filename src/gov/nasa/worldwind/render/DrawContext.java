...
public interface DrawContext extends WWObject, Disposable
{
    ...
    /**
     * Assigns a new <code>PicView</code>. Some layers cannot function properly with a null <code>PicView</code>. It is
     * recommended that the <code>PicView</code> is never set to null during a normal render pass.
     *
     * @param view the enw <code>PicView</code>
     *
     * @since 1.5
     */
    ...
    /**
     * Retrieves the current <code>PicView</code>, which may be null.
     *
     * @return the current <code>PicView</code>, which may be null
     *
     * @since 1.5
     */
    View getView();
