...
public class GlobeBrowserBalloon extends AbstractBrowserBalloon implements GlobeBalloon
{
    ...
    protected void computeBalloonPoints(DrawContext dc, OrderedBrowserBalloon obb)
    {
        ...
        // Compute the eye distance as the distance from the place point to the PicView's eye point.
     ...
     * {@inheritDoc}
     * <p/>
     * Overridden to return <code>false</code> if the balloon's position is either behind the <code>PicView's</code> near
     * clipping plane or in front of the <code>PicView's</code> far clipping plane. Otherwise this delegates to the super
     * class' behavior.
     */
    @Override
