    ...
    extends KeyListener, MouseListener, MouseMotionListener, MouseWheelListener, FocusListener
{
    ...
    /**
     * Animate to the specified position.  The implementation is expected to animate the <code>PicView</code> to look
    ...
    /**
     * Implementations are expected to apply any changes to the {@link gov.nasa.worldwind.View} state prior to the PicView
