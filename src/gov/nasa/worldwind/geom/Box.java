...
public class Box implements Extent, Renderable
{
     ...
     * denotes whether one of the <code>Box's</code> six planes faces the <code>PicView</code>. This code is organized as
     * follows:
     * <p/>
     ...
     * valid combination of planes facing the <code>PicView</code> result in an array of 4 or 6 integers (depending on
     * whether one, two or three planes face the <code>PicView</code>), where each element in the array is an index for one
     ...
     * represent an invalid combination of planes facing the <code>PicView</code> map to <code>null</code>.
     */
     ...
     * <code>Box's</code> six planes faces the <code>PicView</code>. See the documentation for <code>{@link
     ...
     *
     * @param view the <code>PicView</code> to compute a lookup index for.
     *
