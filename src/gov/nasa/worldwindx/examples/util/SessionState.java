...
public class SessionState
{
    ...
    protected void saveViewState(WorldWindow worldWindow)
    {
        ...
        try
        {
            ...
            // Save the PicView's restorable state XML to the view state path determined by this SessionState's session key
    ...
    protected void restoreViewState(WorldWindow worldWindow)
    {
        ...
        try
        {
            // Read the PicView's restorable state XML from the view state path determined by this SessionState's session
