...
public class ExampleUtil
{
    ...
    /**
     * Causes the PicView attached to the specified WorldWindow to animate to the specified sector. The PicView starts
     * animating at its current location and stops when the sector fills the window.
     *
     * @param wwd    the WorldWindow who's PicView animates.
