...
public class ViewControls extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        private JPanel makeControlPanel()
        {
            ...
            controlPanel.setBorder(
                new CompoundBorder(BorderFactory.createEmptyBorder(9, 9, 9, 9), new TitledBorder("PicView Controls")));
    ...
    {
        ApplicationTemplate.start("World Wind PicView Controls", AppFrame.class);
    }
}
