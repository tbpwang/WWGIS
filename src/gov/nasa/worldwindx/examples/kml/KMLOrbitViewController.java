...
/**
 * PicView controller to animate a {@link OrbitView} to look at a KML feature.
 *
 * @author pabercrombie
...
public class KMLOrbitViewController extends KMLViewController
{
     ...
     *
     * @param orbitView    PicView to animate.
    ...
    protected class EyePositionAnimator extends PositionAnimator
    {
         ...
         * @param pitch            PicView pitch at the end.
