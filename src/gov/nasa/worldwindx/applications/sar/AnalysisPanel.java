        ...
        if (pos != null)
        {
            ...
            if (this.trackViewPanel.isExamineViewMode())
            {
                ...
                else
                {
                    ...
                    {
                        view.setCenterPosition(groundPos);
                        // PicView/OrbitView will have logged the exception, no need to log it here.
                    }
                }
            }
...
//     *
//     * @param view the current <code>PicView</code>
...
//     */
//    private Vec4 computeCrosshairPosition(PicView view, Angle a, double distance)
//    {
